...
class wp_schema_plugin_Taxonomy {
  ...
  /**
	...
	public function register_taxonomy () {
        ...
        $labels = array(
            ...
            'update_item' => sprintf( __( 'Update %s' , 'wp-schema-plugin' ), $this->single ),
            'add_new_item' => sprintf( __( 'Add New %s' , 'wp-schema-plugin' ), $this->single ),
            'new_item_name' => sprintf( __( 'New %s Name' , 'wp-schema-plugin' ), $this->single ),
            'parent_item' => sprintf( __( 'Parent %s' , 'wp-schema-plugin' ), $this->single ),
            'parent_item_colon' => sprintf( __( 'Parent %s:' , 'wp-schema-plugin' ), $this->single ),
            'search_items' =>  sprintf( __( 'Search %s' , 'wp-schema-plugin' ), $this->plural ),
            'popular_items' =>  sprintf( __( 'Popular %s' , 'wp-schema-plugin' ), $this->plural ),
            'separate_items_with_commas' =>  sprintf( __( 'Separate %s with commas' , 'wp-schema-plugin' ), $this->plural ),
            'add_or_remove_items' =>  sprintf( __( 'Add or remove %s' , 'wp-schema-plugin' ), $this->plural ),
            'choose_from_most_used' =>  sprintf( __( 'Choose from the most used %s' , 'wp-schema-plugin' ), $this->plural ),
